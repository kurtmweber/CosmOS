...
typedef enum ata_type { IDE_ATA = 0x00, IDE_ATAPI = 0x01 } ata_type;

typedef enum ata_master_slave { ATA_MASTER = 0x00, ATA_SLAVE = 0x01 } ata_master_slave;

typedef enum ata_primary_secondary { ATA_PRIMARY = 0x00, ATA_SECONDARY = 0x01 } ata_primary_secondary;

typedef enum ata_direction { ATA_READ = 0x00, ATA_WRITE = 0x01 } ata_direction;
...
typedef enum ata_registers {
    ...
    ATA_REGISTER_ERROR = 0x01,     // read-only
    ATA_REGISTER_FEATURES = 0x01,  // write-only
    ATA_REGISTER_SECTOR_COUNT_0 = 0x02,
    ATA_REGISTER_LBA_0 = 0x03,
    ATA_REGISTER_LBA_1 = 0x04,
    ATA_REGISTER_LBA_2 = 0x05,
    ATA_REGISTER_HDDEVSEL = 0x06,
    ATA_REGISTER_COMMAND = 0x07,  // write-only
    ATA_REGISTER_STATUS = 0x07,   // read-only
    ATA_REGISTER_SECTOR_COUNT_1 = 0x08,
    ATA_REGISTER_LBA_3 = 0x09,
    ATA_REGISTER_LBA_4 = 0x0A,
    ATA_REGISTER_LBA_5 = 0x0B,
    ATA_REGISTER_CONTROL = 0x0C,
    ATA_REGISTER_ALT_STATUS = 0x0C,
    ATA_REGISTER_DEVADDRESS = 0x0D
} ata_registers;
